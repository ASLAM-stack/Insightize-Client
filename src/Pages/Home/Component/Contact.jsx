...
const Contact = () => {
	...
	<form noValidate="" className="space-y-6">
		...
		<button type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded dark:bg-violet-600 dark:text-gray-50 btn-outline btn">Join us</button>
	</form>
</div>
        </div>
    );
